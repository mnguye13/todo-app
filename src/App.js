  ...
  return (
    <div className="app">
      <nav className="bp3-navbar bp3-dark">
        ...
        <Link to ='/home'><button className="bp3-button bp3-minimal bp3-icon-home">Home</button></Link>
        <span className="bp3-navbar-divider"></span>
        <Link to ='/users'><button className="bp3-button bp3-minimal bp3-icon-user"></button></Link>
        <Link to ='/notifications'><button className="bp3-button bp3-minimal bp3-icon-notifications"></button></Link>
        <Link to ='/settings'><button className="bp3-button bp3-minimal bp3-icon-cog"></button></Link>
        </div>
      </nav>
